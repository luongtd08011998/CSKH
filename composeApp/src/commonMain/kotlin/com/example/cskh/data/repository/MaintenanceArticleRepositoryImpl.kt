...
class MaintenanceArticleRepositoryImpl(
    private val client: HttpClient,
) : MaintenanceArticleRepository {

    override suspend fun getArticles(baseUrl: String, page: Int, size: Int): Result<PagedMaintenanceArticles> = runCatching {
        val url = "${normalizeApiBaseUrl(baseUrl)}/api/v1/qlkh/customer/articles/maintenance?page=$page&size=$size"
